...
#training_x = training[['BARTHAG','WAB','ADJOE','ADJDE','3P_D','TOR','WAS_SEED_AVG']]
...
test_x = pd.DataFrame.drop(test,'SEED',1)
test_x = pd.DataFrame.drop(test_x,'CONF',1)
#test_x = test[['BARTHAG','WAB','ADJOE','ADJDE','3P_D','TOR','WAS_SEED_AVG']]
#test_y = test['POSTSEASON']
print(test_x.columns,training_x.columns)
