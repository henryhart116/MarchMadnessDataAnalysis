...
print(schedule_table[0].find_all("td")[7].a.text)
#matchups = []
...
for i in teams:
    try:
        ...
        for j in schedule_table:
            try:
                matchup_data.append([i,j.find_all("td")[5].a.text,j.find_all("td")[5].a.text,j.find_all("td")[7].a.text])
            except:
                pass
    except:
        print(i)
...
matchups.to_csv('2021Matchups.csv',index=False)
